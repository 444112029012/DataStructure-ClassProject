...
def create_form_elements(root):
    ...
    # 年齡欄位
    age_label = tk.Label(root, text="年齡:")
    ...
    # 緊急程度欄位
    urgency_label = tk.Label(root, text="緊急程度 (數字 1~100):")
...
def create_submit_button(root, name_entry, age_entry, gender_var, urgency_entry, return_data_callback):
    ...
    def submit_data():
        ...
        if not name or not age or not gender or not urgency:
...
def Patien_add_access():
    ...
    name_entry, age_entry, gender_var, urgency_entry = create_form_elements(root)
